    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="/showactivejobs">
                                <i class="fa-solid fa-chevron-left" style="font-size: 20px; margin-top: 1.6rem; margin-left: 3.7rem; color: black"></i>
                            </a>    
                        </div>
                        <div class="col-auto">
                            <h3 class="display-6" style="font-family: 'DM Sans'; font-size: 25px; font-weight: 600; margin-left: 2.5rem; margin-top: 2rem;">Confirm your work</h3>
                        </div>
                </div>
            </div>
        </div>  
        <div class="row pb-5">
            <div class="col-12" style="text-align: center; font-family: 'DM Sans'; font-size: 2.5rem; font-weight: 500;">
                Please upload your proof of work
            </div>
        </div>
        <div class="row">
            <div class="col-2"></div>
        ...
        @php
            $categoriesdetail=json_decode($activeJob->active_job_category_name, true);
        @endphp
        <div class="row mt-5">
            <div class="col-md-6 offset-md-3" style="border: 2.55px solid #516ED7; border-radius: 12.75px; padding: 46px;">
                <div class="row">
                    <div class="col-12 pb-3">
                        <h2 style="color: #9E9E9E; font-size: 2rem; font-family: 'DM Sans';"><b>Job Name</b></h2>
                        <h3 style="font-size: 1.8rem; font-family: 'DM Sans'">{{$activeJob->active_job_name}}</h3>
                    </div>
                    <div class="col-12 pb-3">
                        <div class="row">
                    ...
                    <div class="col-12 pb-3">
                        <h2 style="color: #9E9E9E; font-size: 2rem; font-family: 'DM Sans';"><b>Job Description</b></h2>
                        <h3 style="font-size: 1.8rem; font-family: 'DM Sans'">{{$activeJob->active_job_description}}</h3>
                    </div>
                    <div class="col-12 pb-3">
                        <h2 style="color: #9E9E9E; font-size: 2rem; font-family: 'DM Sans';"><b>Salary</b></h2>
                        <h3 style="font-size: 1.8rem; font-family: 'DM Sans'">Rp. {{$activeJob->active_job_salary}},-</h3>
                    </div>
                    <div class="col-12 pb-3">
                        <h2 style="color: #9E9E9E; font-size: 2rem; font-family: 'DM Sans';"><b>Deadline</b></h2>
                        <h3 style="font-size: 1.8rem; font-family: 'DM Sans'">{{$activeJob->active_job_deadline}}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12" style="padding: 8rem;">
                <a href="success.html" class="btn btn-primary btn-lg btn-block" style="background-color: #516ED7; padding:1em; font-family: 'DM Sans'; font-weight: 500; font-size:1.25rem; color: white; text-decoration: none;">
                    Finish
                </a>
            </div>
        </div> 
