...
<body>
    <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-5 mr-5">
                            <img src={{asset('pics\img-see-detail.png')}} class="img-fluid" alt="image_seedetail">
                        </div>
                        <div class="col-6">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <h2 style="color: #9E9E9E; font-size: 2rem; font-family: 'DM Sans';"><b>Category</b></h2>
                                    </div>
                                    <div class="col-12 pb-3">
                                        <div class="row">
        ...
        <div class="row" style="padding-bottom: 17rem;">
            <div class="col-7" style="margin-left: 7rem;">
